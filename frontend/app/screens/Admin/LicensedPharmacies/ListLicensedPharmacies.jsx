              ...
              {paginatedData.map((item, index) => (
                ...
                >
                  <DataTable.Cell style={styles.textCell}>
                    <Text style={styles.cellText}>{item.licenseNumber}</Text>
                  </DataTable.Cell>
                  <DataTable.Cell style={styles.textCell}>
                    <Text style={styles.cellText}>{item.pharmacyName}</Text>
                  </DataTable.Cell>
                  <DataTable.Cell style={styles.textCell}>
                ...
                label={
                  <Text style={styles.paginationText}>
                    {`${page * itemsPerPage + 1}-${Math.min(
                      (page + 1) * itemsPerPage,
                      pharmaciesFilter.length
                    )} of ${pharmaciesFilter.length}`}
                  </Text>
                }
                theme={{

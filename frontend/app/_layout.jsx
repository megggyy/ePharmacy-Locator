      ...
      <NavigationContainer>
        <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
          <Stack>
            ...
            <Stack.Screen name="screens/Auth/PharmacyStatusScreen" options={{ headerShown: false }} />
            ...
            <Stack.Screen name="screens/PharmacyOwner/Charts/ExpiringStocksChart" options={{ headerShown: false }} />
            <Stack.Screen name="screens/PharmacyOwner/Charts/ReviewsChart" options={{ headerShown: false }} />
            <Stack.Screen name="screens/PharmacyOwner/Reports/Reports" options={{ headerShown: false }} />
            ...
            {/* MEDICATIONS */}
            <Stack.Screen name="screens/PharmacyOwner/Medications/ExpiringMedications" options={{ headerShown: false }} />
            ...
            <Stack.Screen name="screens/Admin/Pharmacies/EditPharmacy" options={{ headerShown: false }} />
             ...
             {/* ADMINS CRUD */}
             <Stack.Screen name="screens/Admin/Admins/ListAdmin" options={{ headerShown: false }} />
            <Stack.Screen name="screens/Admin/Admins/ReadAdmin" options={{ headerShown: false }} />

            {/* LICENSED PHARMACIES CRUD */}
